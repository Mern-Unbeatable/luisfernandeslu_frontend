...
export default function UserVatRateCell({ value, onChange }) {
  ...
  return (
    <div ref={rootRef} className="relative inline-block">
      ...
      {open ? (
        ...
        >
          <p className="text-sm font-bold text-[var(--primary-text)]">Vat rate</p>
          ...
          <div className="mt-4">
            <p className="text-xs font-medium text-[var(--secondary-text)]">Custom</p>
