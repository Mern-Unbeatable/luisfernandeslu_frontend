...
import { useUpdateAdminPromotionMutation } from '@/features/admin/adminPromotionApi'
import { getAuthErrorMessage } from '@/features/auth/authUtils'

const I18N_KEY = 'adminMarketingManagement'

export default function PromotionRejectModal({
  open,
  promotion,
  onClose,
  onRejected,
  ...
  const [updatePromotion, { isLoading: isSubmitting }] =
  ...
  if (!open || !promotion?.id) return null
